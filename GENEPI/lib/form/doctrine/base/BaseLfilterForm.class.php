...
/**
 * Lfilter form base class.
 *
 * @method Lfilter getObject() Returns the current form's model object
 *
 * @package    GENEPI
 * @subpackage form
 ...
 */
abstract class BaseLfilterForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('lfilter[%s]');
