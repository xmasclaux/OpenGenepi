				...
				<table id="<?php echo $table_name ?>" >
				  	<thead>
					    <tr>
					    	...
					    	<th><?php echo __('Shortened name')?></th>
					    	<th><?php echo __('Designation')?></th>
					    </tr>
				  	</thead>
				  	<tbody>
					    <?php foreach ($table_data as $table_entry): ?>
					    	<?php if(!$table_entry->getDisabled()):?>
							    <tr style="height:40px;">
							    	...
							    	<td class="actPrice" align=center><input type="text" size="5" style="text-align: center; border:none;" value="<?php echo $table_entry->getShortenedDesignation()?>"></input></td>
							    	<td align=right><?php echo __($table_entry->getDesignation()) ?></td>
