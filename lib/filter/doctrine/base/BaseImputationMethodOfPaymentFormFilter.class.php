...
/**
 * ImputationMethodOfPayment filter form base class.
 *
 * @package    GENEPI
 * @subpackage filter
 ...
 */
abstract class BaseImputationMethodOfPaymentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('imputation_method_of_payment_filters[%s]');
