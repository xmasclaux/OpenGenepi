...
// date: 2013/12/16 15:25:43
  ...
  'cache_dir' => '/opt/genepi/dev.opengenepi.net/GENEPI-0.9.2/cache/mgmt/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/opt/genepi/dev.opengenepi.net/GENEPI-0.9.2/apps/mgmt/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'swPatternRouting');
      $cache = null;
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/opt/genepi/dev.opengenepi.net/GENEPI-0.9.2/cache/mgmt/prod/template',
  'lifetime' => 86400,
  'prefix' => '/opt/genepi/dev.opengenepi.net/GENEPI-0.9.2/apps/mgmt/template',
)));
