<div>
	...
	<?php if($table_name == PredefinedLists::METHOD_OF_PAYMENT):?>
		<div style="width:100%">
			<div class="info-message-white">
		    	<span class="info-message-icon"></span>
				<em><?php echo __('It is strongly recommended not to delete the \'Account\' and \'Free\' methods of payment')?><br></em>
			</div>
        	...
        	<td style="background: none" valign=top>
				<table id="<?php echo $table_name ?>" >
						    ...
						    <tr style="height:40px;">
						    	...
						    	<td align=right>
						    		<?php if($table_name == PredefinedLists::COMPUTER_OS_FAMILY):?>
						    			<?php echo $table_entry->getFamily() ?>
						    		<?php else:?>
						    			<?php echo __($table_entry->getDesignation()) ?>
						    		<?php endif;?>
						    	</td>
				  	...
				  	<tfoot>
				  		<tr>
				  			<td></td>
				  			<td colspan=2><input style="text-align:right; font-style:italic; font-weight:bold;" type="text" value="<?php echo __('New')?>..."></input></td>
				  		</tr>
					  	<tr>
				...
				<table id="<?php echo $table_name.'_to_delete' ?>">
					<thead>
					    <tr>
					    	...
					    	<th><?php echo __('Order')?></th>
					    	<th><?php echo __('Will be removed')?></th>
					    </tr>
				  </thead>
				  <tbody></tbody>
				  <tfoot>
