...
<?php slot('secondaryMenu') ?>
	...
	<h3 class = "selected"><?php echo __('Temporal statement')?></h3>
...
<h1><?php echo __('Temporal statement')?></h1>

<form action="<?php echo url_for('stat/temporalStatement') ?>" method="post" target="_blank">
	<div class="panel">
