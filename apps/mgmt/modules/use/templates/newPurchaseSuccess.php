<script type = "text/javascript">
	...
	function newTotal(){
		...
		if(($("#imputation_purchase_number_of_unities").val() != '') && ($("#imputation_purchase_unitary_price").val() != '')){
	
			$("#imputation_purchase_imputation_total").val(parseInt($("#imputation_purchase_number_of_unities").val()) * parseFloat($("#imputation_purchase_unitary_price").val()));
		}
	...
	$(document).ready(function(){
		...
		$("#imputation_purchase_number_of_unities").focus();
		...
		$("#imputation_purchase_imputation_account_id").ready(function(){
		...
		$("#imputation_purchase_imputation_account_id").change(function(){
		...
		<?php foreach($users_id as $user_id):?>
			...
			$("#imputation_purchase_imputation_account_id_<?php echo $user_id ?>").ready(function(){
			...
			$("#imputation_purchase_imputation_account_id_<?php echo $user_id ?>").change(function(){
			...
			$("#imputation_purchase_imputation_method_of_payment_id_<?php echo $user_id ?>").change(function(){
				
				if($(this).val() == "<?php echo ImputationDefaultValues::getAccountMethodId() ?>"){
					$("#imputation_purchase_imputation_account_id_<?php echo $user_id ?>").css("visibility","visible");
					$("#status_text_<?php echo $user_id ?>").css("visibility","visible");
					$("#status_<?php echo $user_id ?>").css("visibility","visible");
					
				}else{
					$("#imputation_purchase_imputation_account_id_<?php echo $user_id ?>").css("visibility","hidden");
			...
			$("#imputation_purchase_imputation_method_of_payment_id_<?php echo $user_id ?>").ready(function(){
		...
		$("#imputation_purchase_imputation_method_of_payment_id").change(function(){
			
			if($(this).val() == "<?php echo ImputationDefaultValues::getAccountMethodId() ?>"){
				$("#imputation_purchase_imputation_account_id").css("visibility","visible");
				$("#status_text").css("visibility","visible");
				$("#status").css("visibility","visible");
				
			}else{
				$("#imputation_purchase_imputation_account_id").css("visibility","hidden");
		...
		$("#imputation_purchase_imputation_method_of_payment_id").ready(function(){
		...
		$("#imputation_purchase_imputation_total").focus(function(){
			newTotal();
		});

		$("#imputation_purchase_number_of_unities").blur(function(){
			newTotal();
		});
		
		$("#imputation_purchase_unitary_price").blur(function(){
			newTotal();
		});
...
<?php include_partial('purchaseForm', array('form'                   => $form, 
											'users_id'               => $users_id,
