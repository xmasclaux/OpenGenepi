<script type = "text/javascript">
	...
	$(document).ready(function(){
		...
		$("#imputation_subscription_imputation_total").focus();
		...
		$("#imputation_subscription_imputation_account_id").ready(function(){
		...
		$("#imputation_subscription_imputation_account_id").change(function(){
		...
		<?php foreach($users_id as $user_id):?>
			...
			$("#imputation_subscription_imputation_account_id_<?php echo $user_id ?>").ready(function(){
			...
			$("#imputation_subscription_imputation_account_id_<?php echo $user_id ?>").change(function(){
			...
			$("#imputation_subscription_imputation_method_of_payment_id_<?php echo $user_id ?>").change(function(){
				
				if($(this).val() == "<?php echo ImputationDefaultValues::getAccountMethodId() ?>"){
					$("#imputation_subscription_imputation_account_id_<?php echo $user_id ?>").css("visibility","visible");
					$("#status_text_<?php echo $user_id ?>").css("visibility","visible");
					$("#status_<?php echo $user_id ?>").css("visibility","visible");
					
				}else{
					$("#imputation_subscription_imputation_account_id_<?php echo $user_id ?>").css("visibility","hidden");
			...
			$("#imputation_subscription_imputation_method_of_payment_id_<?php echo $user_id ?>").ready(function(){
		...
		$("#imputation_subscription_imputation_method_of_payment_id").change(function(){
			
			if($(this).val() == "<?php echo ImputationDefaultValues::getAccountMethodId() ?>"){
				$("#imputation_subscription_imputation_account_id").css("visibility","visible");
				$("#status_text").css("visibility","visible");
				$("#status").css("visibility","visible");
				
			}else{
				$("#imputation_subscription_imputation_account_id").css("visibility","hidden");
		...
		$("#imputation_subscription_imputation_method_of_payment_id").ready(function(){
...
<?php include_partial('subscriptionForm', array(
								'form'                   => $form, 
								'users_id'               => $users_id,
